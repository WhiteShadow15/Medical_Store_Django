...
from DjangoMedicalApp.serializers import CompanySerliazer, CompanyBankSerializer, MedicineSerliazer,\
    MedicalDetailsSerializer, MedicalDetailsSerializerSimple,CompanyAccountSerializer,EmployeeSerializer,EmployeeBankSerializer,\
    EmployeeSalarySerializer,BillSerializer,BillDetailsSerializer,CustomerSerializer,CustomerRequestSerializer
...
class MedicineViewset(viewsets.ViewSet):
    ...
    def list(self,request):
        ...
        serializer = MedicineSerliazer(company,many=True,context={"request":request})
        ...
        for medicine in medicine_data:
            ...
            medicine_details_serializer = MedicalDetailsSerializerSimple(medicine_detail,many=True)
